...
## Install Plasma splash Arch-moe from AUR
package="plasma-splash-arch-moe"
...
if yay -Qi $package &> /dev/null; then
	...
	if pacman -Qi yay &> /dev/null; then
		...
		tput setaf 3
		echo $'\n'
		echo "Mooo!!! I will install Plasma splash Arch-moe with Yay... Give me a sec..." | cowsay -n | lolcat
		echo $'\n'
		echo "***************************************************************************"
		echo "***************************************************************************"
		echo $'\n'
